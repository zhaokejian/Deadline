...
public class DatabaseHelper extends SQLiteOpenHelper// 继承SQLiteOpenHelper类
{
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        sBuffer.append("CREATE TABLE " + TABLE_NAME[1] + "(" );
        sBuffer.append("_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,");
        sBuffer.append("title VARCHAR UNIQUE)");
        db.execSQL(sBuffer.toString());

        sBuffer1.append("CREATE TABLE " + TABLE_NAME[0] + "(");
        sBuffer1.append("_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, ");
        sBuffer1.append("title VARCHAR,");
        sBuffer1.append("category VARCHAR,");
        sBuffer1.append("datetime INTEGER,");
        sBuffer1.append("settime INTEGER,");
        sBuffer1.append("alarmtime INTEGER,");
        sBuffer1.append("info TEXT ,");
        sBuffer1.append("isDone INTEGER)");
